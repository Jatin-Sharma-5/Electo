...
const Homepage = () => {
  return (
    <div className="w-full bg-blue-50 py-16">
      <div className="mx-auto max-w-6xl px-6 lg:px-12 flex flex-col-reverse lg:flex-row items-center justify-between gap-12">
        ...
        <div className="text-center lg:text-left max-w-xl">
          ...
          <button className="mt-6 px-6 py-3 rounded-lg bg-gray-900 text-white font-semibold shadow-sm hover:shadow-md transition">
            Shop Now
          </button>
        </div>
